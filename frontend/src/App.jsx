...
import { ArrowRight, ArrowLeft, CalendarDays, DollarSign, Percent, BarChart3, CheckCircle2, User, Building2, Mail, Briefcase, RefreshCw, Send } from "lucide-react";
    ...
    try {
      const response = await axios.post(
        "https://saascalculator-backend.onrender.com", // Make sure this URL is correct for your backend
        {
          ...
          savingsLow: calculatedSavings.low,
          savingsHigh: calculatedSavings.high,
        }
      );
      
      console.log("Backend Response:", response.data);
      toast({ title: "Success!", description: "Savings calculated and details sent to company!", className: "bg-green-600 text-white" });
      setStep(3);
        ...
        return (
          ...
          >
            ...
            <CardContent className="space-y-8">
              ...
              >
                These are estimated savings. Actual results may vary.
              </motion.p>
            </CardContent>
